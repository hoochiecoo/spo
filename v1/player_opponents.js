...
class Content extends React.Component {
    ...
    render() {
        return React.createElement('div', null,
            ...
            React.createElement('div', { id: 'opponents' }, `Opponents for user ${this.state.selectedUser}: ${this.state.opponents.join(', ')}`),
            React.createElement('div', { id: 'not-played-with' }, `Not played with: ${this.state.notPlayedWith.join(', ')}`)
        );
    }
}
